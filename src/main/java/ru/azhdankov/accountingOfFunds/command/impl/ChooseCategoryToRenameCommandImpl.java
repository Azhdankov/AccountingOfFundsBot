...
public class ChooseCategoryToRenameCommandImpl extends CommandHelper
    ...
    public SendMessage run(Update update) {
        ...
        sendMessage.setText(MessageName.CHOOSE_CATEGORY_NAME_FOR_NEXT_RENAMING.getMessageName());
        ...
        if (categoryIDMap.isEmpty()) {
            sendMessage.setText(MessageName.NO_CATEGORY_FOR_RENAME_MESSAGE.getMessageName());
            return sendMessage;
        }
